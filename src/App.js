  ...
  return (
    <div className="App" style={{ textAlign: 'center', height: '100vh', padding: '20px', backgroundColor: '#eaeaea' }}>
      <header style={{ paddingBottom: '1em' }}>
        ...
        <p>Created by: <a href="https://www.linkedin.com/in/wgreunke/" target="_blank" rel="noopener noreferrer">Ward Greunke</a> for the 
        <a href="https://developer.nvidia.com/llamaindex-developer-contest" target="_blank" rel="noopener noreferrer">NVIDIA LLamaIndex Developer Contest</a></p>
      </header>
      <StormMap />
    </div>
  );
